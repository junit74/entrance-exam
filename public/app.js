...
function ratioBadge(value,tiers){
  ...
  return `<span class="ratio-badge ratio-tier-${tier}" aria-label="${rate(value)} 대 1, ${ratioTierLabels[tier]}"><span class="ratio-value">${rate(value)}<small>: 1</small></span><span class="ratio-tier-label">${ratioTierLabels[tier]}</span></span>`;
}
